...
<div class="col-12 order-md-last mt-4 pb-5">
    ...
    <div class="list-group">
        <?php foreach($orders as $sale_order){
            ...
            <a href="#<?php echo $sale_order->id?>" class="list-group-item list-group-item-action d-flex gap-3 py-3" aria-current="true" onclick="location.href='<?php echo ROOT_URL . 'user/?page=my_order&id=' . ($sale_order->id); ?>'">
                <img src="../../STEP1/assets/imgs/icons8lampada96.png" alt="logo" width="32" height="32" class="rounded-circle flex-shrink-0">
    ...
    <a href="#<?php ROOT_PATH . 'STEP1/public/pages/product_list.php'?>" class="btn btn-primary" onclick="location.href='<?php echo ROOT_URL . '?page=product_list';?>'">Vai ai prodotti</a>
</div>
<?php }?>
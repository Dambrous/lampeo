...
<div class="col-12 order-md-last mt-4 pb-5">
                ...
                <div class="col-lg-4 col-6">
                    <div class="row">
                        <div class="col-lg-6 col-6 d-none d-md-block">
                            <img src="../back-end/db_images/<?php echo $product->image ?>" width="140" height="140" alt="IMG">
                        </div>
    ...
    <?php } else {?>
        ...
        <a href="#<?php ROOT_PATH . 'front-end/public/pages/product_list.php'?>" class="btn btn-primary" onclick="location.href='<?php echo ROOT_URL . '?page=product_list';?>'">Torna a fare acquisti</a>
    <?php }?>
</div>
